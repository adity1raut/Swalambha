  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-16">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Voting History</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">View your complete voting record</p>
        </div>
